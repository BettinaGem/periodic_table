   ...
   then
      ...
      then
       ...
       END_MENU(){
        ...
        MELTING=$($PSQL "SELECT melting_point_celsius FROM properties WHERE atomic_number= '$SELECTED_ATOMIC_NUMB'")
        BOILING=$($PSQL "SELECT boiling_point_celsius FROM properties WHERE atomic_number= '$SELECTED_ATOMIC_NUMB'")
        TYPE_ID=$($PSQL "SELECT type_id FROM properties WHERE atomic_number= '$SELECTED_ATOMIC_NUMB'")
